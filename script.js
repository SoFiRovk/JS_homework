...
const unit = username % 10;
const tens = Math.trunc(username / 10) % 10;
const hundred = Math.trunc(username / 100) % 10;
console.log(
  `В числе ${username} количество сотин ${hundred}, десятков ${tens} и единиц ${unit}`
);
